...
const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  const {yourProgress} = lngs[language.toLowerCase() as keyof typeof lngs].screening;
  ...
  return (
    <div className="p-3 bg-white shadow-md rounded-lg">
      <div className="flex justify-between items-center mb-2">
        <span className="text-gray-600">{yourProgress}</span>
        <span className="text-gray-500 text-sm">{totalDays} days</span>
      </div>
      <div className="text-primary-color font-bold text-lg mb-2">
