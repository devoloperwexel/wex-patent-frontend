...
const SmallCalendarNew: React.FC<SmallCalendarNewProps> = ({
  onSelectDate,
  selectedDate,
}) => {
  ...
  const renderHeader = () => (
    <div className="flex items-center justify-between mb-3">
      <div className="flex items-center">
        <p className="text-primary-color font-bold text-[17px] mr-2">
        ...
        <select
          ...
          onChange={(e) =>
            setCurrentDate(
              new Date(currentDate.setFullYear(Number(e.target.value)))
            )
          }
        >
